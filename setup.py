...
if __name__ == '__main__':
    setuptools.setup(
        name="vaik-rainbow-text-gif-generator",
        version="1.0.0",
        url="https://github.com/vaik-info/vaik-rainbow-text-gif-generator.git",
        ...
        description="generate rainbow text gif file",
        long_description="generate rainbow text gif file",
